...
int (*call_vec[])(void) = {
	...
	do_get,		/* 113 = getsid	*/
	do_setvar, /* 114 = setvar */
	do_getvar, /* 115 = setvar */
	do_children, /* 116 = children */
	do_maxChildren, /* 117 = maxChildren */
	do_whoMaxChildren, /* 118 = whoMaxChildren */
	do_maxDescendantsExceptPID,  /* 119 = maxDescendantsExceptPID */ // bez tego nie wyrzucalo bledu
};
