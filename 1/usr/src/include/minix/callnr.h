#define NCALLS		 120	/* number of system calls allowed */
...
#define PM_SETVAR 	114/* PM setvar()*/
#define PM_GETVAR 	115/* PM getvar()*/
#define PM_CHILDREN 116/* PM children*/
#define MAXCHILDREN 117 /* new system call */
#define WHOMAXCHILDREN 118 /* new system call */
#define MAXDESCENDANTSEXCEPTPID 119 /* new system call */
